      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="nav-item{{ request()->is('customers') ? ' active' : '' }}"><a href="{{ url('/customers') }}"><i class="fas fa-user-friends"></i><span> Customers</span></a></li>
            <li class="nav-item{{ request()->is('kamar') ? ' active' : '' }}"><a href="{{ url('/kamar') }}"><i class="fas fa-chalkboard-teacher"></i><span>Kamar</span></a></li>
            <li class="nav-item{{ request()->is('hargahariini') ? ' active' : '' }}"><a href="{{ url('/hargahariini') }}"><i class="fas fa-book-open"></i><span>Harga Hari Ini</span></a></li>
            <li class="nav-item{{ request()->is('invoice') ? ' active' : '' }}"><a href="{{ url('/invoice') }}"><i class="far fa-bell"></i><span>Invoice</span></a></li>  
            <li class="nav-item{{ request()->is('pembayaran') ? ' active' : '' }}"><a href="{{ url('/pembayaran') }}"><i class="fas fa-users"></i><span>Pembayaran</span></a></li>
            <li class="nav-item{{ request()->is('reservasi') ? ' active' : '' }}"><a href="{{ url('/reservasi') }}"><i class="fas fa-user-graduate"></i><span>Reservasi</span></a></li>
          </ul>
            </li>
          </ul>
