...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-link" href="<?php echo e(route('kamar.index')); ?>">Kamar</a>
    ...
    <div class="container">
        ...
        <a href="<?php echo e(route('kamar.create')); ?>" class="btn btn-primary mb-3">Tambah Pengguna</a>
        <table class="table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $kamar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $pgn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td><?php echo e($pgn->nama_cutomer); ?></td>
...
<?php /**PATH D:\laragon\www\hotel\resources\views/kamar/index.blade.php ENDPATH**/ ?>