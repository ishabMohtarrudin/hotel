      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="nav-item<?php echo e(request()->is('customers') ? ' active' : ''); ?>"><a href="<?php echo e(url('/customers')); ?>"><i class="fas fa-user-friends"></i><span> Customers</span></a></li>
            <li class="nav-item<?php echo e(request()->is('kamar') ? ' active' : ''); ?>"><a href="<?php echo e(url('/kamar')); ?>"><i class="fas fa-chalkboard-teacher"></i><span>Kamar</span></a></li>
            <li class="nav-item<?php echo e(request()->is('hargahariini') ? ' active' : ''); ?>"><a href="<?php echo e(url('/hargahariini')); ?>"><i class="fas fa-book-open"></i><span>Harga Hari Ini</span></a></li>
            <li class="nav-item<?php echo e(request()->is('invoice') ? ' active' : ''); ?>"><a href="<?php echo e(url('/invoice')); ?>"><i class="far fa-bell"></i><span>Invoice</span></a></li>  
            <li class="nav-item<?php echo e(request()->is('pembayaran') ? ' active' : ''); ?>"><a href="<?php echo e(url('/pembayaran')); ?>"><i class="fas fa-users"></i><span>Pembayaran</span></a></li>
            <li class="nav-item<?php echo e(request()->is('reservasi') ? ' active' : ''); ?>"><a href="<?php echo e(url('/reservasi')); ?>"><i class="fas fa-user-graduate"></i><span>Reservasi</span></a></li>
          </ul>
            </li>
          </ul>
...
</html><?php /**PATH C:\laragon\www\hotel\resources\views/template/app.blade.php ENDPATH**/ ?>